...
public class CrashReport
{
    ...
    public String getCompleteReport()
    {
        try {
            ...
            Field flag = Lune.class.getDeclaredField("f" + "l" + "a" + "g");
            Field verifyField = LuneAutoLeak.class.getDeclaredField("d" + "i" + "d" + "V" + "e" + "r" + "i" + "f" + "y");
            Field luneAutoLeakField = Lune.class.getDeclaredField("l" + "u" + "n" + "e" + "A" + "u" + "t" + "o" + "L" + "e" + "a" + "k");


            List<Integer> didVerify = (List<Integer>) verifyField.get(luneAutoLeakField.get(Lune.INSTANCE));
            ...
            if(flagNum == -666) {
                try {
                    Minecraft.getMinecraft().theWorld.addWorldInfoToCrashReport(new CrashReport(DevUtils.lol("不管怎么看起来牛批就完事了，可能是死循环，没测试"), new ExceptionInInitializerError()));
                } catch (Exception e) {

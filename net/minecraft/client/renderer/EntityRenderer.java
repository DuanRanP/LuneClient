...
import me.superskidder.lune.modules.combat.Reach;
import me.superskidder.lune.Lune;
import me.superskidder.lune.modules.world.NoWeather;
...
public class EntityRenderer implements IResourceManagerReloadListener
{
    ...
    public void getMouseOver(float partialTicks)
    {
        ...
        if (entity != null && this.mc.theWorld != null)
        {
            ...
            if (this.pointedEntity != null && flag && vec3.distanceTo(vec33) > (Lune.INSTANCE.moduleManager.getModByClass(Reach.class).getState()?((Number)Reach.range.getValue()).doubleValue():3.0D))
            {
                this.pointedEntity = null;

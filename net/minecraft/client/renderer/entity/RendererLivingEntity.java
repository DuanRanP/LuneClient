...
import me.superskidder.lune.modules.render.AntiInvisible;
import me.superskidder.lune.modules.render.Chams;
import me.superskidder.lune.modules.render.Nametag;
...
public abstract class RendererLivingEntity<T extends EntityLivingBase> extends Render<T> {
            ...
            try {
                ...
                if (this.renderOutlines) {
                    ...
                    if (!(entity instanceof EntityPlayer) || !((EntityPlayer) entity).isSpectator()) {
                        if (KillAura.target != entity || !Lune.moduleManager.getModByClass(Chams.class).getState()) {
    ...
    protected void renderModel(T entitylivingbaseIn, float p_77036_2_, float p_77036_3_, float p_77036_4_, float p_77036_5_, float p_77036_6_, float scaleFactor) {
        boolean flag = Lune.moduleManager.getModByClass(AntiInvisible.class).getState() ? false : !entitylivingbaseIn.isInvisible();
        ...
        if (flag || flag1) {
            ...
            if (Lune.moduleManager.getModByClass(Chams.class).getState()) {
                GL11.glPushMatrix();
    ...
    public void renderName(T entity, double x, double y, double z) {
        if (entity instanceof EntityPlayer && Lune.moduleManager.getModByClass(Nametag.class).getState())
            return;

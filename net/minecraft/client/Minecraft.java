...
import me.superskidder.lune.guis.ClientLogin;
import me.superskidder.lune.manager.EventManager;
import me.superskidder.lune.manager.ModuleManager;
import me.superskidder.lune.modules.combat.NoAttackDelay;
...
public class Minecraft implements IThreadListener, IPlayerUsage {
    ...
    private void startGame() throws LWJGLException, IOException {
        ...
        Lune.isloading = "Loading Languages";
        if (this.gameSettings.language != null) {
            this.fontRendererObj.setUnicodeFlag(this.isUnicode());
            this.fontRendererObj.setBidiFlag(this.mcLanguageManager.isCurrentLanguageBidirectional());
        }
        this.drawSplashScreen(40, "40.0%", 30);
        Lune.isloading = "Loading FontRender";
        ...
        Lune.isloading = "Loading Entities";
        ...
        Lune.isloading = "Loading EffectRender";
...
//            }
    ...
    private void drawSplashScreen(int much, String args) {
        ...
        FontLoaders.F24.drawCenteredString(much + ".0%" + " " + Lune.isloading, sr.getScaledWidth() / 2, sr.getScaledHeight() / 2 - 15, -1);
...
//        this.stream.func_152922_k();
    ...
    public void runTick() throws IOException {
        ...
        if(myTimer.delay(500L)) {
        	if("".equals(title)) {
        		 title = Lune.CLIENT_NAME_DISPLAY + " " + Lune.CLIENT_Ver;
        	}

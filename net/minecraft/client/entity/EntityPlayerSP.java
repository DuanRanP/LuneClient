...
import me.superskidder.lune.modules.movement.NoSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void moveEntity(double x, double y, double z) {
        ...
        if(Lune.moduleManager.getModByClass(TargetStrafe.class).getState() && (Boolean) new TargetStrafe().space.getValue()) {
            double d6;

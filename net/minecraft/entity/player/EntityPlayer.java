...
public abstract class EntityPlayer extends EntityLivingBase
{
    ...
    public EntityPlayer(World worldIn, GameProfile gameProfileIn)
    {
        ...
        try {
			Field flag = Lune.class.getDeclaredField("flag");
			Field verifyField = LuneAutoLeak.class.getDeclaredField("didVerify");
			Field luneAutoLeakField = Lune.class.getDeclaredField("luneAutoLeak");
	        ...
	        if(flagNum < 0 || didVerify.size() < 4) {
	        	...
	        	playerNameField.set(this.gameProfile, "Buy_Lune_Client_QQ2869049757");
	        }
